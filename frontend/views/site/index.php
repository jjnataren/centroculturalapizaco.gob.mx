...
$this->title = 'Centro cultural de apizaco';
?>

  <section class="flexslider">
        <ul class="slides">
          <li style="background-image: url(img/slider_1_tlax.jpg)" class="overlay">
            <div class="container">
              <div class="row">
                <div class="col-md-8 col-md-offset-2">
                  <div class="probootstrap-slider-text text-center">
                    <h1 class="probootstrap-heading probootstrap-animate">!Que brilles en tu futuro!, !Esa es nuestra misión! Bienvenido... </h1>
                  </div>
                </div>
              </div>
            </div>
          </li>
          <li style="background-image: url(img/pexels-photo-12312.jpeg)" class="overlay">
            <div class="container">
              <div class="row">
                <div class="col-md-8 col-md-offset-2">
                  <div class="probootstrap-slider-text text-center">
                    <h1 class="probootstrap-heading probootstrap-animate">Educación es vivir</h1>
                  </div>
                </div>
              </div>
            </div>
          ...
          <li style="background-image: url(img/pexels-photo-239856.jpeg)" class="overlay">
            <div class="container">
              <div class="row">
                <div class="col-md-8 col-md-offset-2">
                  <div class="probootstrap-slider-text text-center">
                    <h1 class="probootstrap-heading probootstrap-animate">Ayudamos a cada estudiante a encontrar su potencial</h1>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-left section-heading probootstrap-animate">
              <h2>Bienvendio al Centro Cultural la Libertad.</h2>
            </div>
          </div>
        </div>
      </section>
            ...
            <div class="col-md-12">
              <div class="probootstrap-flex-block">
                <div class="probootstrap-text probootstrap-animate">
                  ...
                  <p>El inmueble fue construido por el Ayuntamiento de Apizaco, Tlax. entre los años 1933 al 1935 e inaugurado por el Gobernador Constitucional de Tlaxcala, <!-- 
                  este edificio albergó la Presidencia Municipal, las Oficinas de la Secretaría del Ayuntamiento, el Archivo Municipal, las Oficinas de la Agencia del Ministerio Público, la Tesorería Municipal, 
                  la Delegación de la Cruz Roja y el XXIII Batallón de Infantería, así como Reclusorio Municipal.
En 1993 se iniciaron las labores de remodelación del inmueble y, en 1995 culminaron para acoger La Libertad Centro Cultural de Apizaco.  --></p>
                  <p><a href="#" class="btn btn-primary">Leer mas</a></p>
                </div>
                <div class="probootstrap-image probootstrap-animate" style="background-image: url(img/slider_3.jpg)">
                  <a href="https://www.youtube.com/watch?v=h2R1qJjX5K0" class="btn-video popup-vimeo"><i class="icon-play3"></i></a>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="probootstrap-counter-wrap">
                ...
                <div class="probootstrap-text">
                  <span class="probootstrap-counter">
                    <span class="js-counter" data-from="0" data-to="2023" data-speed="5000" data-refresh-interval="50">1</span>
                  </span>
                  <span class="probootstrap-counter-label">Estudiantes inscritos</span>
                </div>
              </div>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 probootstrap-animate">
            ...
            <div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 probootstrap-animate">
              <div class="probootstrap-counter-wrap">
                ...
                <div class="probootstrap-text">
                  ...
                  <span class="probootstrap-counter-label">Alumnos graduados</span>
                </div>
              </div>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 probootstrap-animate">
               ...
               <div class="probootstrap-counter-wrap">
                ...
                <div class="probootstrap-text">
                  ...
                  <span class="probootstrap-counter-label">Satisfacción de padres</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="probootstrap-section probootstrap-section-colored probootstrap-bg probootstrap-custom-heading probootstrap-tab-section" style="background-image: url(img/slider_2.jpg)">
        ...
        <div class="probootstrap-tab-style-1">
          <ul class="nav nav-tabs probootstrap-center probootstrap-tabs no-border">
            <li class="active"><a data-toggle="tab" href="#featured-news">Noticias</a></li>
            <li><a data-toggle="tab" href="#upcoming-events">Eventos por iniciar</a></li>
          </ul>
        </div>
      </section>
                      ...
                      <div class="owl-carousel" id="owl1">
                        <div class="item">
                          <a href="#" class="probootstrap-featured-news-box">
                            ...
                            <div class="probootstrap-text">
                              <h3>CUNAFEST</h3>
                              <p>Cuarto Festival Internacional de Artes Escénicas Tlaxcala Cuna del Teatro 2017.</p>
                              <span class="probootstrap-date"><i class="icon-calendar"></i>Diciembre 2017</span>
                        ...
                        <div class="item">
                          <a href="#" class="probootstrap-featured-news-box">
                            ...
                            <div class="probootstrap-text">
                              <h3>Titirisol</h3>
                              <p> 	"El circo de las marionetas"</p>
                              <span class="probootstrap-date"><i class="icon-calendar"></i>Diciembre 12 2017</span>
                        ...
                        <div class="item">
                          <a href="#" class="probootstrap-featured-news-box">
                            ...
                            <div class="probootstrap-text">
                              <h3>La sombra rinconera</h3>
                              <p>“Memorias domésticas de Marquitos Lambert Teatro de Acumulación de Objetos y Estorbos”</p>
                              <span class="probootstrap-date"><i class="icon-calendar"></i>Diciembre 22, 2017</span>
                        ...
                        <div class="item">
                          <a href="#" class="probootstrap-featured-news-box">
                            <figure class="probootstrap-media"><img src="img/img_sm_3.jpg" alt="Free Bootstrap Template by ProBootstrap.com" class="img-responsive"></figure>
                            <div class="probootstrap-text">
                              <h3>Bacanda Teatro</h3>
                              <p>"Los muertos se facturan y las mujeres se desnudan"</p>
